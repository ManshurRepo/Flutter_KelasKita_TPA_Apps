...
import 'package:flutter_cbt_tpa_app/presentation/oboarding/widgets/onboarding_content.dart';
import 'package:flutter_cbt_tpa_app/presentation/oboarding/widgets/onboarding_indicator.dart';
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  final onboardingData = [
    OnboardingModel(image: Assets.images.onboarding.screen1.path, 
    text: 'Jelajahi Potensimu dengan Tes Online Akademik di CWB !'),
    OnboardingModel(image: Assets.images.onboarding.screen2.path, 
    text: 'Jelajahi Potensimu dengan Tes Online Akademik di CWB !'),
    OnboardingModel(
